	...
	<div class="container-fluid">
		<div class="d-flex">
			<a class="header-brand" href="index.html">
				<img src="{{'/clients/img/vinnytsia-ukraine-december-23-2023-260nw-2404229805-removebg-preview.png'}}"
					class="header-brand-img desktop-lgo" alt="Clont logo"> Thái Hòa Từ Liêm
				<img src="{{'/clients/img/vinnytsia-ukraine-december-23-2023-260nw-2404229805-removebg-preview.png'}}"
					class="header-brand-img dark-logo" alt="Clont logo">
			</a>
				...
				<div class="dropdown ">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
						<div class="text-center">
							...
							<span class="text-center user-semi-title text-dark">{{ auth()->user()?->role }}</span>
							<div class="dropdown-divider"></div>
						</div>
						<a class="dropdown-item" href="#">
							<i class="dropdown-icon mdi mdi-account-outline "></i> Thông tin
						</a>
						<a class="dropdown-item" href="#">
							<i class="dropdown-icon  mdi mdi-settings"></i> Cài đặt
						</a>
						<a class="dropdown-item" href="#">
							<i class="dropdown-icon mdi  mdi-message-outline"></i> hộp thư đến
						</a>
						<a class="dropdown-item" href="#">
							<i class="dropdown-icon mdi mdi-comment-check-outline"></i> tin nhắn
						</a>
						<a class="dropdown-item" href="{{ route('Logout')  }}">
							<i class="dropdown-icon mdi  mdi-logout-variant"></i> Đăng xuất
						</a>
					</div>
				</div>
			</div>
